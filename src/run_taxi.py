...
def run_taxi(episodes):
    ...
    # Show final Q table
    actions_labels = [f"Action {i}" for i in range(n_actions)]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the Taxi-v3 environment.")
    parser.add_argument("--episodes", type=int, default=2000, help="The number of episodes to run.")
    args = parser.parse_args()
    run_taxi(args.episodes)
